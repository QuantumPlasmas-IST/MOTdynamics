...
function_names = [lambda x:x, lambda x, y:x + y] #aqui esta a operar em strings
...
optConstrains=ps.ConstrainedSR3(constraint_lhs=constraint_lhs,constraint_rhs=constraint_rhs,threshold=.5,thresholder='l0') 
